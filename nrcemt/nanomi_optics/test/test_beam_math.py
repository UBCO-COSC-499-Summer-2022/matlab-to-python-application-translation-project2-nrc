...
def test_transfer_free():
    np.testing.assert_allclose(
        lense.transfer_free(257.03),
        [[1, 257.03], [0, 1]]
    )
    np.testing.assert_allclose(
        lense.transfer_free(349),
        [[1, 349], [0, 1]]
    )
    np.testing.assert_allclose(
        lense.transfer_free(168),
        [[1, 168], [0, 1]]
    )
    np.testing.assert_allclose(
        lense.transfer_free(13.69253780272917),
        [[1, 13.6925378], [0, 1]]
    )
    np.testing.assert_allclose(
        lense.transfer_free(91.97000000000003),
        [[1, 91.97], [0, 1]]
    )
    np.testing.assert_allclose(
        lense.transfer_free(38.90127388535032),
        [[1, 38.90127389], [0, 1]]
    )
...
def test_transfer_thin():
    np.testing.assert_allclose(
        lense.transfer_thin(13),
        [[1, 0], [-0.07692308, 1]],
        rtol=1e-5
    )
    np.testing.assert_allclose(
        lense.transfer_thin(35),
        [[1, 0], [-0.02857143, 1]],
        rtol=1e-5
    )
    np.testing.assert_allclose(
        lense.transfer_thin(10.68545),
        [[1, 0], [-0.0935852, 1]],
        rtol=1e-5
    )
...
def test_vacuum_matrix():
    ray_out, distance = lense.vacuum_matrix(
        257.03,
    ...
    ray_out1, distance1 = lense.vacuum_matrix(
        13.69253780272917,
    ...
    ray_out2, distance2 = lense.vacuum_matrix(
        168,
...
def test_thin_lens_matrix():
    ray_out, img_location, distance = lense.thin_lens_matrix(
        349, 35,
        [[-0.05293346], [-0.00066602]])
    np.testing.assert_allclose(
        ray_out,
        [[-0.05293346], [0.00084636]],
        rtol=1e-5
