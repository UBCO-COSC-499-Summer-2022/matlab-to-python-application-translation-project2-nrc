...
class BelowSampleFrame(ttk.LabelFrame):
    ...
    def __init__(self, master):
        ...
        distance_toggle = ToggleButton(distance_frame, "c1")
        ...
        objective_toggle = ToggleButton(objective_frame, "c1")
        ...
        intermediate_toggle = ToggleButton(intermediate_frame, "c1")
        ...
        projective_toggle = ToggleButton(projective_frame, "c1")
