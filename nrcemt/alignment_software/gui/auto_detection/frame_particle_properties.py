...
class ParticlePropertiesFrame(tk.Frame):
    ...
    def shift_search_areas_frame(self, frame):
        ...
        marker_radius_input = tk.Entry(frame, width=INPUT_WIDTH)
        ...
        search_area_width_input = tk.Entry(frame, width=INPUT_WIDTH)
        ...
        search_area_height_input = tk.Entry(frame, width=INPUT_WIDTH)
