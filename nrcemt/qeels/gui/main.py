...
def ui():
    ...
    bulkPlasmon1_button=ttk.Radiobutton(root,text="Bulk Plasmon 1",value="bp1",variable=selectedButton)
    ...
    #y input
    ttk.Label(root,text="Y: ").place(x=initWidth+textSeperation,y=initHeight*2)
    ...
    bulkPlasmon2_button=ttk.Radiobutton(root,text="Bulk Plasmon 2",value="bp2",variable=selectedButton)
    ...
    #y input
    ttk.Label(root,text="Y: ").place(x=secondWidth+textSeperation,y=initHeight*2)
    ...
    #width
    ttk.Label(root,text="Width: ").place(x=secondWidth+2*textSeperation+textWidth,y=initHeight*2)
    bpWidth_entry=ttk.Entry(root,textvariable=bpWidth,width=7)
    bpWidth_entry.place(x=secondWidth+2*textSeperation+3*textWidth+5,y=initHeight*2)
    #detect
    ...
    surfacePlasmonUpper1_button=ttk.Radiobutton(root,text="Surface Plasmon Upper 1",value="spu1",variable=selectedButton)
    ...
    #y input
    ttk.Label(root,text="Y: ").place(x=initWidth+textSeperation,y=initHeight*5)
    ...
    surfacePlasmonUpper2_button=ttk.Radiobutton(root,text="Surface Plasmon Upper 2",value="spu2",variable=selectedButton)
    ...
    #y input
    ttk.Label(root,text="Y: ").place(x=secondWidth+textSeperation,y=initHeight*5)
    ...
    #width
    ttk.Label(root,text="Width: ").place(x=secondWidth+2*textSeperation+textWidth,y=initHeight*5)
    spuWidth_entry=ttk.Entry(root,textvariable=spuWidth,width=7)
    spuWidth_entry.place(x=secondWidth+2*textSeperation+3*textWidth+5,y=initHeight*5)
    #detect
    ...
    surfacePlasmonLower1_button=ttk.Radiobutton(root,text="Surface Plasmon Lower 1",value="spl1",variable=selectedButton)
    ...
    #y input
    ttk.Label(root,text="Y: ").place(x=initWidth+textSeperation,y=initHeight*8)
    ...
    surfacePlasmonLower2_button=ttk.Radiobutton(root,text="Surface Plasmon Lower 2",value="spl2",variable=selectedButton)
    ...
    #y input
    ttk.Label(root,text="Y: ").place(x=secondWidth+textSeperation,y=initHeight*8)
    ...
    #width
    ttk.Label(root,text="Width: ").place(x=secondWidth+2*textSeperation+textWidth,y=initHeight*8)
    splWidth_entry=ttk.Entry(root,textvariable=splWidth,width=7)
    splWidth_entry.place(x=secondWidth+2*textSeperation+3*textWidth+5,y=initHeight*8)
    #detect
